(function(global) {
    ...
    const translations = {
        de: {
            ...
            'Certificate Key Type': 'Zertifikats-Schlüsseltyp',
            '(?) RSA 2048 requests Let\'s Encrypt RSA/R certificates for Exchange compatibility.': '(?) RSA 2048 fordert Let\'s-Encrypt-RSA/R-Zertifikate für Exchange-Kompatibilität an.',
            'RSA 2048 (Exchange compatible)': 'RSA 2048 (Exchange-kompatibel)',
            'RSA 4096': 'RSA 4096',
            ...
            'En': 'Aktiv',
            'Domain': 'Domain',
            'Additional Hostnames (SANs, comma separated)': 'Zusätzliche Hostnamen (SANs, kommagetrennt)',
            'www.example.com, autodiscover.example.com': 'www.example.com, autodiscover.example.com',
            'autodiscover.example.com, legacy.example.com': 'autodiscover.example.com, legacy.example.com',
            'Port': 'Port',
            'Desc': 'Beschr.',
            'Actions': 'Aktionen',
            'Subdomain': 'Subdomain',
            ...
            'Renew all as RSA': 'Alle als RSA erneuern',
            ...
            'Existing Certificates': 'Vorhandene Zertifikate',
            'Windows PFX Export': 'Windows-PFX-Export',
            'Export a certificate and private key as a password-protected': 'Exportiere ein Zertifikat und den privaten Schlüssel als passwortgeschützte',
            'file for Windows import.': 'Datei für den Windows-Import.',
            'Certificate/key pair': 'Zertifikat/Key-Paar',
            'PFX Password': 'PFX-Passwort',
            ...
            'Select a certificate/key pair first.': 'Wähle zuerst ein Zertifikat/Key-Paar.',
            'Enter a PFX password first.': 'Gib zuerst ein PFX-Passwort ein.',
            'PFX export started.': 'PFX-Export gestartet.',
            'No certificate/key pairs found': 'Keine Zertifikat/Key-Paare gefunden',
            'Expires': 'Läuft ab',
            'Unknown': 'Unbekannt',
            'Unreadable': 'Nicht lesbar',
            'expired': 'abgelaufen',
            'expires today': 'läuft heute ab',
            '{days} days left': '{days} Tage verbleibend',
            'Issuer': 'Aussteller',
            'Source': 'Quelle',
            'Renew now': 'Jetzt erneuern',
            'Not renewable': 'Nicht erneuerbar',
            'Renewal failed.': 'Erneuerung fehlgeschlagen.',
            'Renewal requested.': 'Erneuerung angefordert.',
            'Delete the stored certificate assets and restart Caddy to request a new certificate for {name}?': 'Gespeicherte Zertifikatsdateien löschen und Caddy neu starten, um ein neues Zertifikat für {name} anzufordern?',
            'Set certificate key type to RSA 2048, delete stored Caddy-managed ACME certificates, and restart Caddy to request new RSA certificates?': 'Zertifikats-Schlüsseltyp auf RSA 2048 setzen, gespeicherte Caddy-ACME-Zertifikate löschen und Caddy neu starten, um neue RSA-Zertifikate anzufordern?',
            'Missing certificate references found.': 'Fehlende Zertifikatsreferenzen gefunden.',
            'Remove missing references': 'Fehlende Referenzen entfernen',
            'Remove all missing certificate references from the configuration?': 'Alle fehlenden Zertifikatsreferenzen aus der Konfiguration entfernen?',
            'Missing certificate references removed.': 'Fehlende Zertifikatsreferenzen entfernt.',
            'Certificate {name} is still referenced by the configuration.': 'Zertifikat {name} wird noch von der Konfiguration referenziert.',
            'Remove these references and delete the file?': 'Diese Referenzen entfernen und die Datei löschen?',
            'Domain custom certificate': 'Domain: benutzerdefiniertes Zertifikat',
            'Domain custom certificate key': 'Domain: Schlüssel für benutzerdefiniertes Zertifikat',
            'Domain client auth trust pool': 'Domain: Client-Auth Trust Pool',
            'Subdomain client auth trust pool': 'Subdomain: Client-Auth Trust Pool',
            'Handler upstream TLS trusted CA': 'Handler: Upstream-TLS Trusted CA',
            'Layer 4 custom certificate': 'Layer 4: benutzerdefiniertes Zertifikat',
            'Layer 4 custom certificate key': 'Layer 4: Schlüssel für benutzerdefiniertes Zertifikat',
            'Custom upload': 'Manueller Upload',
            'Caddy-managed ACME': 'Caddy-verwaltetes ACME',
            'Request result:': 'Abruf-Ergebnis:',
            'Status error:': 'Statusfehler:',
            'Status updated:': 'Status aktualisiert:',
            'Caddy admin API:': 'Caddy-Admin-API:',
            'reachable': 'erreichbar',
            'not reachable': 'nicht erreichbar',
            'Configured ACME targets:': 'Konfigurierte ACME-Ziele:',
            'No valid Let\'s Encrypt targets are configured.': 'Keine gültigen Let\'s-Encrypt-Ziele konfiguriert.',
            'No valid Let\'s Encrypt targets are configured. Enable Let\'s Encrypt on a public domain first.': 'Keine gültigen Let\'s-Encrypt-Ziele konfiguriert. Aktiviere Let\'s Encrypt zuerst auf einer öffentlichen Domain.',
            'Target': 'Ziel',
            'Certificate found': 'Zertifikat gefunden',
            'Waiting for certificate': 'Warte auf Zertifikat',
            'Recent ACME log entries:': 'Aktuelle ACME-Logeinträge:',
            'No matching ACME log entries yet. Keep this panel open after requesting.': 'Noch keine passenden ACME-Logeinträge. Lass dieses Panel nach dem Abruf geöffnet.',
            ...
            'Matcher Values (SNI/Host/IPs, comma separated)': 'Matcher-Werte (SNI/Host/IPs, kommagetrennt)',
